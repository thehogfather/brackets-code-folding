/**
 * Based on http://codemirror.net/addon/fold/xml-fold.js
   Modulised by:
...
define(function (require, exports, module) {
    ...
    function tagAt(iter, ch) {
        var type = iter.cm.getTokenTypeAt(CodeMirror.Pos(iter.line, ch));
    ...
    function findMatchingClose(iter, tag) {
        var stack = [];
        for (;;) {
            var next = toNextTag(iter), end, startLine = iter.line, startCh = iter.ch - (next ? next[0].length : 0), i;
    ...
    function findMatchingOpen(iter, tag) {
        ...
        for (;;) {
            ...
            var endLine = iter.line, endCh = iter.ch, i;
